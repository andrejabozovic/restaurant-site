  ...
  return (
    ...
    {/* Our features */}
      <div 
        ...
        style={{ 
          background: 'linear-gradient(to bottom, #161616 50%, #ffffff 50%)',
          paddingBottom: '100px'
        }}
      >
        <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-md-5 mb-30 mt-60 text-white">
                ...
                <div className="reservations mb-10" style={{ display: 'flex', alignItems: 'center', marginTop: '20px' }}>
                  ...
                  <div className="text">
                    <p className="color-1 mb-0" style={{ color: '#c19d68' }}>Reservation</p> 
                    <a className="color-1" href="tel:855-100-4444" style={{ color: '#c19d68', fontSize: '20px', fontWeight: 'bold' }}>
                      855 100 4444
                    </a>
                  </div>
                </div>
